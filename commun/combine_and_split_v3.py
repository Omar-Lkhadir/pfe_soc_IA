"""
v3 : ajoute Zeek/IoT-23 (données réelles, commun/data/zeek_canonical.pkl)
comme 3e source, en plus de NetFlow + CICFlowMeter. Même logique que
combine_and_split.py (split stratifié source x label), sortie _v3.
"""
...
print("=" * 70)
print("COMBINAISON v3 — NetFlow + CICFlowMeter + Zeek/IoT-23")
print("=" * 70)
...
df_train.to_pickle(os.path.join(DATA_DIR, 'combined_train_v3.pkl'))
df_test.to_pickle(os.path.join(DATA_DIR, 'combined_test_v3.pkl'))
print(f"\n✓ Sauvegardé -> commun/data/combined_train_v3.pkl, combined_test_v3.pkl")
print("=" * 70)
